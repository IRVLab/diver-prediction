...
class DataLoader():
    ...
    def __init__(self,f_prefix, batch_size=4, seq_length=10, num_of_validation = 0, forcePreProcess=False, infer=False, generate = False):
        ...
        # base test files
        base_test_dataset=  [ '/data/unstabilized/test/IRVLab/pool_swimmer_004_A.txt'#pool_flipper_001_A.txt'#, '/data/test/IRVLab/pool_flipper_003_A_0009.txt'#/data/test/biwi/biwi_eth.txt',
        ...
        #base train files
        base_train_dataset = ['/data/unstabilized/train/IRVLab/pool_swimmer_001_A.txt'#pool_flipper_003_A_0001.txt'#, '/data/test/IRVLab/pool_flipper_003_A_0004.txt'#/data/train/biwi/biwi_hotel.txt',
        ...
        self.base_train_path = 'data/unstabilized/train/'
        self.base_test_path = 'data/unstabilized/test/'
        self.base_validation_path = 'data/unstabilized/valid/'
    ...
    def frame_preprocess(self, data_dirs, data_file, validation_set = False):
        ...
        for directory in data_dirs:
            ...
            column_names = ['frame_num','ped_id','xmin','ymin','xmax','ymax']
            ...
            if self.infer is False:
                ...
                # if test mode, read test file to pandas dataframe and process
                    ...
                    column_names = ['frame_num','ped_id','xmin','ymin','xmax','ymax']
                    df = pd.read_csv(directory, dtype={'frame_num':'int','ped_id':'int' }, delimiter = ' ',  header=None, names=column_names, converters = {c:lambda x: float('nan') if x == '?' else float(x) for c in ['xmin','ymin','xmax','ymax']})
            ...
            for ind, frame in enumerate(frameList):
                ...
                for ped in pedsList:
                    ...
                    pedsWithPos.append([ped, current_xmin, current_ymin, current_xmax, current_ymax])
