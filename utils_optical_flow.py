...
class DataLoader():
    ...
    def __init__(self,f_prefix, batch_size=4, seq_length=10, num_of_validation = 0, forcePreProcess=False, infer=False, generate = False):
        ...
        #base train files
        base_train_dataset = ['/mnt/data1/vdd_optical_flow_labels/train/IRVLab/pool_swimmer_001_A.txt'#pool_flipper_003_A_0001.txt'#, '/data/test/IRVLab/pool_flipper_003_A_0004.txt'#/data/train/biwi/biwi_hotel.txt',
    ...
    def load_preprocessed(self, data_file, validation_set = False):
        ...
        for dataset in range(len(self.data)):
            ...
            num_seq_in_dataset = int(len(all_frame_data) / (self.seq_length+1))
    ...
    def next_batch(self):
        ...
        while i < self.batch_size:
            ...
            if idx + self.seq_length + 1 <= len(frame_data):
                ...
                seq_numPedsList = numPedsList[idx:idx+self.seq_length+1]
                seq_PedsList = pedsList[idx:idx+self.seq_length+1]
    ...
    def tick_batch_pointer(self, valid=False):
        ...
        if not valid:
            ...
            if self.dataset_pointer >= len(self.data):
                print("OUT OF DATA GOING TO ORIGINAL")
