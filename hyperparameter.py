    ...
    for hyperparams in itertools.islice(sample_hyperparameters(), args.num_samples):
        ...
        for epoch in range(args.num_epochs):
            ...
            for batch in range(dataloader_t.num_batches):
                ...
                # Get batch data
                x, y, d , numPedsList, PedsList ,_ = dataloader_t.next_batch()
                ...
                for sequence in range(dataloader_t.batch_size):
                    ...
                    if args.method == 2: #obstacle lstm
                        grid_seq = getSequenceGridMask(x_seq, dataset_data, PedsList_seq, args.neighborhood_size, args.grid_size, args.use_cuda, lookup_seq, True)
        ...
        for batch in range(dataloader_v.num_batches):
            ...
            print('Current file : ', dataloader_v.get_file_name(0),' Batch : ', batch+1, ' Sequence: ', sequence+1, ' Sequence mean error: ', err,' Sequence final error: ',f_err, 'IoU: ',IoU, 'Final IoU: ',fIoU,' time: ', end - start)
            ...
            IoU_batch /= dataloader_v.batch_size
            fIoU_batch /= dataloader_v.batch_size
        ...
        if dataloader_v.num_batches != 0:            
            ...
            fIoU_epoch /= dataloader_v.num_batches
            IoU_epoch /= dataloader_v.num_batches
            ...
            print('valid_loss = {:.3f}, valid_mean_err = {:.3f}, valid_final_err = {:.3f}, meanIoU = {:.3f}, finalIoU = {:.3f}, score = {:.3f}, time = {:.3f}'.format(loss_epoch, err_epoch, f_err_epoch, IoU_epoch, fIoU_epoch, avg_err, elapsed_time))
            log_file.write('valid_loss = {:.3f}, valid_mean_err = {:.3f}, valid_final_err = {:.3f}, meanIoU = {:.3f}, finalIoU = {:.3f}, score = {:.3f}, time = {:.3f}'.format(loss_epoch, err_epoch, f_err_epoch,  IoU_epoch, fIoU_epoch, avg_err, elapsed_time)+'\n')
